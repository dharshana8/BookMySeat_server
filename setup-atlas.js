...
async function setupAtlasData() {
  try {
    ...
    if (!ATLAS_URI || !ATLAS_URI.includes('mongodb.net')) {
      console.log('❌ Please set MONGO_URI to your Atlas connection string in .env file');
      process.exit(1);
    }
    
    await mongoose.connect(ATLAS_URI);
    console.log('🌐 CONNECTED TO MONGODB ATLAS');
    console.log('🔄 SETTING UP ATLAS DATA FOR PRODUCTION...\n');
    ...
    console.log('✅ Created 3 users for Atlas');
    ...
    console.log('✅ Created 3 coupons for Atlas');
    ...
    // Insert buses in batches for Atlas
    const batchSize = 100;
    ...
    console.log(`✅ Created ${buses.length} buses for Atlas`);
